...
ACheckPoint::ACheckPoint()
{
	...
	RespawnLocation->SetupAttachment(Box);
}
...
{
	//MainCharacter->MainCharacterLocation = RespawnLocation->GetComponentLocation();
	bIsDestroyed = true;
	GameInstance->SaveData(RespawnLocation->GetComponentLocation());
}
