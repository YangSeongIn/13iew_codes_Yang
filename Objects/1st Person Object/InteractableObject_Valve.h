/*
* Header "InteractableObject_Valve"
* Created by Yang
* Last Modified by Yang
* Description:
* Rotate valve to open door. The gauge fills while the valve rotates and the door opens when complete.
* Used on second floor in level2 toilet.
*/
